  ...
  'Telangana': [
    {
      ...
      category: 'Post-Matric Scholarships & Overseas Grants',
      description: 'Official Government of Telangana ePASS portal for post-matric scholarships, fee reimbursement, and Ambedkar Overseas Vidya Nidhi.',
      targetSchemes: ['epass', 'scholarship', 'telangana', 'reimbursement']
    },
    {
      name: 'Telangana MeeSeva Portal',
      url: 'https://ts.meeseva.telangana.gov.in',
      domain: 'ts.meeseva.telangana.gov.in',
      category: 'Certificates & Citizen Paperwork',
      description: 'Official Government of Telangana digital services portal for income, caste, and residence certifications.',
