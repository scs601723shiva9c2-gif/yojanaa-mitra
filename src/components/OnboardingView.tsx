...
export const OnboardingView: React.FC = () => {
  ...
  const [formData, setFormData] = useState<Partial<UserProfile>>({
    ...
    state: (currentUser?.state === 'Andhra Pradesh' || currentUser?.state === 'Telangana') ? currentUser.state : 'Telangana',
    district: currentUser?.district || (currentUser?.state === 'Andhra Pradesh' ? 'Visakhapatnam' : 'Hyderabad'),
