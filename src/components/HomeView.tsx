                ...
                <div>
                  <h2 className="text-xl font-bold text-stone-900 tracking-tight flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold px-2.5 py-0.5 rounded-full bg-amber-100 text-amber-900 border border-amber-300">
                      {eligibleStatePool.length} eligible
                    </span>
                    {isStatePanelClosed && (
            ...
            <div className="flex items-start sm:items-center gap-3.5">
              ...
              <div>
                <h4 className="text-sm font-bold text-stone-900 flex items-center gap-2">
                  ...
                  <span className="text-[10px] uppercase font-extrabold px-2 py-0.5 bg-amber-100 text-amber-900 rounded-md">
                    {eligibleStatePool.length} Schemes Available
                  </span>
                </h4>
